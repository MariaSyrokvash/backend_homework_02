...
exports.blogsRouter.get('/:id', blogValidators_1.findBlogValidator, findBlogController_1.getBlogController);
exports.blogsRouter.post('/', admin_middleware_1.adminMiddleware, ...blogValidators_1.blogValidators, createBlogController_1.createBlogController);
exports.blogsRouter.put('/:id', admin_middleware_1.adminMiddleware, blogValidators_1.findBlogValidator, ...blogValidators_1.blogValidators, putBlogController_1.putBlogController);
